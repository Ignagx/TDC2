...
Se muestra en la Figura \ref{fig:esquematico_circuito_2} el circuito sobre el que se trabajará, que constituye un filtro elimina banda o notch de segundo orden. Los valores de los componentes son:
...
\begin{figure}[H]
  ...
  \label{fig:esquematico_circuito_2}
\end{figure}

\subsection{Análisis y Simulación}
\label{sec:analisis_circ_2}

Para el analisis se transforma el circuito a su equivalente en laplace como se ve en la Figura \ref{fig:laplace_circuito_2}.

\begin{figure}[H]
  \centering
  \input{figures/circuito_2_laplace.tikz}
  \caption{Equivalente en laplace del circuito 2.}
  \label{fig:laplace_circuito_2}
\end{figure}
...
Se muestran estos polos graficados en el plano complejo en la Figura \ref{fig:polos_circuito_2}. Ambos polos se ubican sobre el eje real izquierdo, lo que garantiza la estabilidad del circuito.

\begin{figure}[H]
  \centering
  \input{figures/plot_poles_circuito_2.tex}
  \caption{Polos en el plano complejo de la FDT del circuito 2.}
  \label{fig:polos_circuito_2}
\end{figure}
...
La Figura \ref{fig:polar_circuito_2} muestra el diagrama polar obtenido de la FDT ideal.

\begin{figure}[H]
  \centering
  \input{figures/plot_polar_circuito_2.tex}
  \caption{Diagrama polar de la FDT del circuito 2 (ideal).}
  \label{fig:polar_circuito_2}
\end{figure}

\begin{figure}[H]
  \centering
  \input{figures/plot_asymptotic_gain_circuito_2.tex}
  \caption{Diagrama de Bode de Magnitud del circuito 2 (Simulado vs Asintótico).}
  \label{fig:bode_mag_circuito_2}
\end{figure}

\begin{figure}[H]
  \centering
  \input{figures/plot_asymptotic_phase_circuito_2.tex}
  \caption{Diagrama de Bode de Fase del circuito 2 (Simulado vs Asintótico).}
  \label{fig:bode_phase_circuito_2}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{cccc}
    ...
    \SI{1}{\hertz}       & \SI{1.75}{\volt}                      & \SI{1.75}{\volt}                       & \SI{0.00}{\decibel}    \\
    \SI{2}{\hertz}       & \SI{1.75}{\volt}                      & \SI{1.75}{\volt}                       & \SI{0.00}{\decibel}    \\
    \SI{10}{\hertz}      & \SI{1.75}{\volt}                      & \SI{1.62}{\volt}                       & \SI{-0.67}{\decibel}   \\
    \SI{20}{\hertz}      & \SI{1.75}{\volt}                      & \SI{1.25}{\volt}                       & \SI{-2.92}{\decibel}   \\
    \SI{50}{\hertz}      & \SI{1.52}{\volt}                      & \SI{0.65}{\volt}                       & \SI{-7.38}{\decibel}   \\
    \SI{100}{\hertz}     & \SI{1.52}{\volt}                      & \SI{0.34}{\volt}                       & \SI{-13.01}{\decibel}  \\
    \SI{200}{\hertz}     & \SI{1.50}{\volt}                      & \SI{0.14}{\volt}                       & \SI{-20.59}{\decibel}  \\
    \SI{500}{\hertz}     & \SI{1.47}{\volt}                      & \SI{0.05}{\volt}                       & \SI{-29.36}{\decibel}  \\
    \SI{1}{\kilo\hertz}  & \SI{1.47}{\volt}                      & \SI{0.11}{\volt}                       & \SI{-22.52}{\decibel}  \\
    \SI{2}{\kilo\hertz}  & \SI{1.50}{\volt}                      & \SI{0.27}{\volt}                       & \SI{-14.89}{\decibel}  \\
    \SI{5}{\kilo\hertz}  & \SI{1.60}{\volt}                      & \SI{0.66}{\volt}                       & \SI{-7.69}{\decibel}   \\
    \SI{10}{\kilo\hertz} & \SI{1.68}{\volt}                      & \SI{1.12}{\volt}                       & \SI{-3.52}{\decibel}   \\
    \SI{20}{\kilo\hertz} & \SI{1.80}{\volt}                      & \SI{1.50}{\volt}                       & \SI{-1.58}{\decibel}   \\
    \SI{50}{\kilo\hertz} & \SI{1.90}{\volt}                      & \SI{1.75}{\volt}                       & \SI{-0.72}{\decibel}   \\
    \SI{100}{\kilo\hertz}& \SI{1.93}{\volt}                      & \SI{1.80}{\volt}                       & \SI{-0.61}{\decibel}   \\
    \SI{200}{\kilo\hertz}& \SI{1.92}{\volt}                      & \SI{1.80}{\volt}                       & \SI{-0.56}{\decibel}   \\ \hline
  \end{tabular}
  \caption{Mediciones experimentales del circuito 2 en el laboratorio (valor eficaz).}
  \label{tab:mediciones_circuito_2}
\end{table}

\begin{figure}[H]
  \centering
  \input{figures/plot_bode_medido_circuito_2.tex}
  ...
  \label{fig:bode_medido_circuito_2}
\end{figure}

A partir de las mediciones graficadas en la Figura \ref{fig:bode_medido_circuito_2}, se observa un buen acuerdo general con la respuesta simulada. A frecuencias muy bajas (\SI{1}{\hertz} y \SI{2}{\hertz}) la ganancia es prácticamente unitaria (\SI{0}{\decibel}), confirmando que las señales de baja frecuencia pasan sin atenuación. A medida que la frecuencia se aproxima a la zona de rechazo, la atenuación crece progresivamente hasta alcanzar un mínimo de \SI{-29.36}{\decibel} a \SI{500}{\hertz}, coincidiendo con la frecuencia de resonancia teórica de $f_0 \approx \SI{491}{\hertz}$. A frecuencias superiores, la ganancia se recupera gradualmente hasta valores cercanos a \SI{0}{\decibel} en \SI{100}{\kilo\hertz} y \SI{200}{\kilo\hertz}, verificando el comportamiento característico del filtro notch.

Para registrar con mayor resolución la respuesta en frecuencia completa del filtro en el entorno de la sintonía, se capturó la pantalla del osciloscopio mostrada en la Figura \ref{fig:fft_circuito_2}, la cual grafica la respuesta obtenida mediante la Transformada Rápida de Fourier (FFT), donde se aprecia claramente la fosa del notch centrada en la frecuencia de resonancia.
