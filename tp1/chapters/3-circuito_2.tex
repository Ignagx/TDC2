...
A partir de las mediciones graficadas en la Figura \ref{plot:bode_medido_vs_teorico_circuito_2}, se observa un buen acuerdo general con la respuesta simulada. A frecuencias muy bajas (\SI{1}{\hertz} y \SI{2}{\hertz}) la ganancia es prácticamente unitaria (\SI{0}{\decibel}), confirmando que las señales de baja frecuencia pasan sin atenuación. A medida que la frecuencia se aproxima a la zona de rechazo, la atenuación crece progresivamente hasta alcanzar un mínimo de \SI{-29.36}{\decibel} a \SI{500}{\hertz}, coincidiendo con la frecuencia de resonancia teórica de $f_0 \approx \SI{491}{\hertz}$. A frecuencias superiores, la ganancia se recupera gradualmente hasta valores cercanos a \SI{0}{\decibel} en \SI{100}{\kilo\hertz} y \SI{200}{\kilo\hertz}, verificando el comportamiento característico del filtro notch.

Para registrar con mayor resolución la respuesta en frecuencia completa del filtro en el entorno de la sintonía, se capturó la pantalla del osciloscopio mostrada en la Figura \ref{img:bode_medido_circuito_2}, la cual grafica la respuesta obtenida mediante la Transformada Rápida de Fourier (FFT), donde se aprecia claramente la fosa del notch centrada en la frecuencia de resonancia.
