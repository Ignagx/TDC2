...
Se muestra en la Figura \ref{fig:esquematico_circuito_3} el circuito sobre el que se trabajará, que constituye un filtro pasa banda
...
\begin{figure}[H]
  ...
  \label{fig:esquematico_circuito_3}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Polos en el plano complejo de la FDT del circuito 3.}
  \label{fig:polos_circuito_3}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Diagrama polar de la FDT del circuito 3 (ideal).}
  \label{fig:polar_circuito_3}
\end{figure}
